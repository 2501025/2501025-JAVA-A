...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        String[][] customers = new String[][] {{"1111", "홍길동", "1", ""}, {"2222", "이순신", "2", ""},
                {"7777", "한민국", "3", ""}, {"3333", "이대한", "4", ""}, {"8888", "경복대", "5", ""},
                {"4444", "정성호", "4", ""}, {"9999", "김남국", "2", ""}, {"5555", "황철현", "3", ""},
                {"1010", "조동국", "5", ""}, {"6666", "이예린", "1", ""}};

        for (int i = 0; i < customers.length; i++) {
            Input.preProcess(customers[i]);
        }
        float[] used = Input.readData(customers);
        int[][] money = new int[customers.length][3];  //  {사용 요금, 세금, 징수금액}
